#!/usr/bin/env python3
"""
Test on Full Dataset — NeuroFetal AI V6.0 (Stacking Ensemble)
=============================================================
Runs the *complete* V6.0 Stacking Ensemble (AttentionFusionResNet × 5,
...
def main():
    print("=" * 70)
    print("  NeuroFetal AI V6.0 — Full Dataset Inference (Stacking Ensemble)")
    print("=" * 70)
    ...
    if has_full_ensemble:
        print("  → Full V6.0 Stacking Ensemble available.")
    ...
    md_content = f"""# NeuroFetal AI V6.0 — Full Dataset Inference Report
