...
\begin{titlepage}
  ...
  {\Huge \bfseries NeuroFetal-AI: A Tri-Modal Architecture with Cross-Modal Attention for Cardiotocography Classification}\\[0.75em]
  ...
  \begin{itemize}[label=\textbullet, leftmargin=2.5cm]
      ...
      \item Bodkhe Yash Sanjay (IIT2023180)
